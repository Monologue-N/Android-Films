...
public class TopRatedMovies {
    private final static String TAG = "[topRatedMovies] ";
    RequestQueue queue;
    JSONArray arr;


    public void getTopRatedMovies(final VolleyCallback cb, Context cxt) {
        queue = Volley.newRequestQueue(cxt.getApplicationContext());

        // Instantiate the RequestQueue.
        String url = "https://sixth-starlight-308222.wn.r.appspot.com/apis/posts/topRatedMovies";
